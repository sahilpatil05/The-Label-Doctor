...
def extract_ingredients(text):
    ...
    final_ingredients = []
    garbage = [
        'and', 'or', 'the', 'a', 'of', 'for', 'in', 'as', 'is', 'with', 'to',
        'moodles', 'mustaranufacture', 'wgredlenis', 'rurhecoaer', 'conans',
        'contain', 'may', 'regulators', 'aadty', 'contains', 'contains.',
        'e.g', 'such as', 'eg', 'includes', 'including', 'ingredients',
        'product', 'produced', 'allergen', 'allergens'
    ]
    ...
    for item in comma_split:
        ...
        # Skip if it's just a garbage word
